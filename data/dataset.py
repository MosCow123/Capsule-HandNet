...
class HandPointDataset(data.Dataset):
    def __init__(self, root_path, opt, train=True):
        ...
        self.train = train
        self.size = opt.size                             # full
        self.test_index = opt.test_index                 # 0

        self.PCA_SZ = opt.PCA_SZ                         # 42
        self.SAMPLE_NUM = opt.SAMPLE_NUM                 # 1024
        self.INPUT_FEATURE_NUM = opt.INPUT_FEATURE_NUM   # 6
        self.JOINT_NUM = opt.JOINT_NUM                   # 21
